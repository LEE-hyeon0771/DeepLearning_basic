...
class MyTrainer:
    def __init__(self, model, input_data, target_data, test_data, num_epochs=100, learning_rate=0.01):
        self.model = model
    ...
    def train(self):
        for epoch in range(self.num_epochs):
            ...
            loss = self.criterion(output_data, self.target_data)
...
if __name__ == "__main__":
    ...
    input_data, target_data, test_data = data_loader.load_data()

    model = MyModel()
    trainer = MyTrainer(model, input_data, target_data, test_data)
    trainer.train()
